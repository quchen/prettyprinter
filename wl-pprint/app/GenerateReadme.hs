...
readmeContents = (mconcat . L.intersperse vspace)
    ...
    , h3 "Annotation support"
        , paragraph "Text is not all letters and newlines. Often, we want to add more information, the simplest kind being some form of styling. An ANSI terminal supports coloring, a web browser a plethora of different formattings."
